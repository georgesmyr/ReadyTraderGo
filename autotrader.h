...
private:
    ...
    // ETF SPREAD STATISTICS
    unsigned long mETFBestBid {0};
    unsigned long mETFBestAsk {0};
    double mETFSpreadstd {0};
    double mETFSpreadmean {0};

    // HEDGING
    unsigned long mHedgeCounter {0};
    bool mHedge {false};
    signed long mFuturePosition {0};
    unsigned long mFutureBidId {0};
    unsigned long mFutureAskId {0};
